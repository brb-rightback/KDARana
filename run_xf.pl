...
if($config eq "rate" || $config eq "rate_nons" || $config eq "rate_antibdt" || $config eq "rate_nofhcrhc" || $config eq "rate_constantibdt" || $config eq "rate_constproton" || $config eq "rate_lowE"|| $config eq "rate_hiE" ){
